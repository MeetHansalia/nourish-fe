...
const LanguageDropdown = () => {
  ...
  return (
    <>
      <IconButton ref={anchorRef} onClick={handleToggle} className='bg-theme-icon text-textPrimary mis-2'>
        {/* <i className='tabler-language' /> */}
        <img src='/images/logo/language.svg' alt='language'></img>
      </IconButton>
      <Popper
        open={open}
        transition
