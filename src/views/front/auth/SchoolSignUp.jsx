 ...
 * Page
 */
const SchoolSignUp = ({ mode, dictionary }) => {
  // Hooks
  ...
  const formValidationSchema = yup.object({
    ...
    // schoolAddress: yup.string().required(dictionary?.form?.validation?.required),
    ...
    <div className='two-common-signup'>
      <div className='left-side-common'>
        <div className='left-side-common-img'>
          <img src='/images/nourishubs/front/banner-sign-up.jpg' alt='banner'></img>
        </div>
        <div className='left-side-text'>
          <h1>{dictionary?.page?.signUpSchool?.meal_string}</h1>
          <p>{dictionary?.page?.signUpSchool?.join_string}</p>
        </div>
      </div>
      <div className='right-side-common'>
        <div className='right-side-common-inner'>
          <div className='form-title'>
            ...
            <p>{dictionary?.page?.signUpSchool?.solution_string}</p>
          </div>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <CustomTextField
                        ...
                        {...(errors?.schoolAddress && { error: true, helperText: errors?.schoolAddress?.message })}
                      />
                    )}
                  />
                </div> */}
