          ...
          <Box sx={{ overflowY: 'auto', flex: 1, pr: 1 }}>
            {schoolData.map((item, index) => (
              <Card
                ...
                onClick={() =>
                  router.push(getLocalizedUrl(`/area/school-vendor-associates/schools/${item._id}`, locale))
                }
              >
          ...
          <Box sx={{ overflowY: 'auto', flex: 1, pr: 1 }}>
            {vendorData.map((item, index) => (
              <Card
                ...
                onClick={() =>
                  router.push(getLocalizedUrl(`/area/school-vendor-associates/vendors/${item._id}`, locale))
                }
              >
                <Avatar sx={{ mr: 2 }}>🏢</Avatar>
                <CardContent sx={{ flex: 1 }}>
