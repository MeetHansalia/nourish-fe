...
const OrderReviewTable = props => {
  ...
  const getAllCompletedOrders = async () => {
    ...
    try {
      const response = await axiosApiCall.get(API_ROUTER.AREA_EXECUTIVE.REVIEW_LIST, {
        params: {
          page,
          limit: itemsPerPage,
  ...
  const getVendorData = async () => {
    ...
    try {
      const response = await axiosApiCall.get(API_ROUTER.AREA_EXECUTIVE.GET_AREA_VENDOR_LIST, {
        params: {
          page,
          // limit: itemsPerPage,
      ...
      const responseVendor = response?.data?.response?.users || []
