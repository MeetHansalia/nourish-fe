...
// View Imports
import UserCard from '@/views/dashboard/super-admin/user-management/UserCard'
 ...
 * Page
 */
const MenuNutritionManagement = props => {
  // Props
  ...
  const getUsers = async (fnInput = null) => {
    ...
    if (isNeedToUpdateWholeList) {
      // const pageLastUsed = page - 1 || 1
      // const pageLastUsed = pageRef.current - 1 || 1
...
export default MenuNutritionManagement
