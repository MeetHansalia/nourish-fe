...
const NearByVendorDialog = props => {
  ...
  // useEffect(() => {
  //   if (vendorListInView && vendorsListApiInput?.hasMore && isNearVendorDialogShow && vendors?.length > 0) {
  //     console.log('getNearByVendorsList 3')
  ...
  // useEffect(() => {
  //   if (vendorListInView && vendorsListApiInput?.hasMore && isNearVendorDialogShow && vendors?.length > 0) {
  //     console.log('getNearByVendorsList 4')
