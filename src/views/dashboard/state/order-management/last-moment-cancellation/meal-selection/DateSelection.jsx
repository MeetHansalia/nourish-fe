...
return;
  ...
  return (
      ...
      <Grid item xs={12}>
        <Card>
          <CardContent>
            ...
            <Button variant='contained' color='primary' sx={{ mt: 2 }} onClick={handleRedirect} disabled={isSubmitting}>
    ...
    <DialogContent>
      ...
      {dictionary?.dialog?.your_cart_contains_dishes_for} {oldCartDate}. {orderType == 'single' ? dictionary?.dialog?.do_you_want_to_discard : dictionary?.dialog?.do_you_want_to} {orderType == 'single' ? singleDate : ''}
      </DialogContentText>
    </DialogContent>
