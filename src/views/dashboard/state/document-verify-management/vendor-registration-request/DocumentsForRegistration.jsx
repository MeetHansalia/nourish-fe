...
const DocumentsForVerification = props => {
  ...
  const getSubmittedDocuments = async () => {
    setIsLoading(true)
    await axiosApiCall
      .get(API_ROUTER.STATE.GET_VENDOR_UPLOADED_DOC(id))
      .then(response => {
    ...
    actionConfirmWithLoaderAlert(
      {
         ...
         */
        deleteUrl: API_ROUTER.STATE.PATCH_VENDOR_REGISTRATION_REQUESTS,
  ...
  const handleReject = async () => {
    ...
    await axiosApiCall
      .patch(API_ROUTER.STATE.PATCH_VENDOR_REGISTRATION_REQUESTS, requestBody)
      .then(response => {
