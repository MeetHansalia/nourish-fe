...
const AddEventSidebar = props => {
  ...
  const [viewMenuDialog, setViewMenuDialog] = useState(false)
  ...
  const handleShowMenu = (vendor, thresh, vendorDetails) => {
    console.log('vendor', vendor)
    setViewMenuDialog(true)
  ...
  const getNearByVendorsList = () => {
    ...
    axiosApiCall
      .get(API_ROUTER.SCHOOL_FOODCHART.GET_FOODCHART_DATA_NEARBY, {
  ...
  return (
    <>
                                  ...
                                  <div className='flex flex-col'>
                                    <Typography className='font-medium' color='text.primary'>
                                      ...
                                      <Button
                                        ...
                                        variant='contained'
                                        color='success'
                                        onClick={() => handleShowMenu(vendor?._id, vendor.minThresHold, vendor)}
                                      >
                                        {t('page.food_chart_creation.see_more')}
                                      </Button>
                                      {/* <span onClick={() => handleShowMenu(vendor?._id, vendor.minThresHold)}>
                                        ({t('page.food_chart_creation.see_more')})
                                      </span> */}
                                    </Typography>
                                  </div>
      ...
      <ViewMenuDialog
        ...
        setViewMenuDialog={setViewMenuDialog}
        threshhold={threshhold}
        dialogProps={vendorData}
      />
    </>
  )
}
