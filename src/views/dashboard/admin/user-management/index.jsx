...
// View Imports
import Statistics from '@/views/dashboard/admin/user-management/Statistics'
import UserCard from '@/views/dashboard/admin/user-management/UserCard'
...
const UserManagement = props => {
  ...
  const getTotalSuspendedAccountNumber = async () => {
    ...
    await axiosApiCall
      .get(API_ROUTER.ADMIN_USER.STATISTIC)
      .then(response => {
  ...
  const getUsers = async (fnInput = null) => {
    ...
    await axiosApiCall
      .get(API_ROUTER.ADMIN_USER.ALL_USERS, {
    ...
    actionConfirmWithLoaderAlert(
      {
         ...
         */
        deleteUrl: `${API_ROUTER.ADMIN_USER.SPECIFIC_USER_WITH_ID(userId)}/status`,
  ...
  const userAccessHandler = async (id = null) => {
    ...
    axiosApiCall
      .get(API_ROUTER.ADMIN_USER.GET_ACCESS_USER(id), {
