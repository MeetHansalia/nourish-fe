...
// View Imports
import Statistics from '@/views/dashboard/district/user-management/Statistics'
import UserCard from '@/views/dashboard/district/user-management/UserCard'
...
const UserManagement = props => {
  ...
  const getTotalSuspendedAccountNumber = async () => {
    ...
    await axiosApiCall
      .get(API_ROUTER.DISTRICT_USER.STATISTIC)
      .then(response => {
  ...
  const getUsers = async (fnInput = null) => {
    ...
    await axiosApiCall
      .get(API_ROUTER.DISTRICT_USER.ALL_USERS, {
    ...
    actionConfirmWithLoaderAlert(
      {
         ...
         */
        deleteUrl: `${API_ROUTER.DISTRICT_USER.SPECIFIC_USER_WITH_ID(userId)}/status`,
    ...
    actionConfirmWithLoaderAlert(
      {
         ...
         */
        deleteUrl: `${API_ROUTER.DISTRICT_USER.SPECIFIC_USER_WITH_ID(userId)}`,
  ...
  const userAccessHandler = async (id = null) => {
    ...
    axiosApiCall
      .get(API_ROUTER.DISTRICT_USER.GET_ACCESS_USER(id), {
