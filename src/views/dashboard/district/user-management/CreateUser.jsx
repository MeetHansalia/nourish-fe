...
const CreateUser = props => {
  ...
  const onSubmit = values => {
    ...
    let axiosApiCallUrl = API_ROUTER.DISTRICT_USER.CREATE_USER

    if (id) {
      axiosApiCallUrl = API_ROUTER.DISTRICT_USER.SPECIFIC_USER_WITH_ID(id)
    }
  ...
  const fetchUserData = (id = null) => {
    ...
    axiosApiCall
      .get(API_ROUTER.DISTRICT_USER.SPECIFIC_USER_WITH_ID(id), {
