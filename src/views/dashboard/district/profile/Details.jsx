      ...
      <CardContent>
        <List>
          <ListItem className='flex justify-center'>
            <label htmlFor='imageUpload' style={{ cursor: 'pointer' }}>
              <div className='flex rounded-bs-md mbs-[-40px] border-[5px] mis-[-5px] border-be-0  border-backgroundPaper bg-backgroundPaper'>
                <CustomAvatar
                  src={
                    preview || // Show preview if an avatar is selected
                    (userData?.avtar ? AVATARS[userData.avtar] : userData?.profileImage) ||
                    '/'
                  }
          ...
          <ListItem className='flex justify-center items-center'>
            <Chip variant='tonal' size='small' label={dictionary?.page?.common?.district} color='primary' />
          </ListItem>
        </List>
        ...
        <div className='mt-2'>
          <div className='flex flex-col gap-2'>
            ...
            <div className='flex items-center flex-wrap gap-2'>
              ...
              <Typography className='capitalize'>{dictionary?.page?.common?.district}</Typography>
            </div>
            <div className='flex items-center flex-wrap gap-2'>
