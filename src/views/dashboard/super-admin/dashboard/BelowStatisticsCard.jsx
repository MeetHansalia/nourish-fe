  ...
  const content = (
    <Card className='card-link-a'>
      <CardContent className='flex flex-col gap-1'>
        ...
        <div className='number-text-block-inner flex items-center justify-between w-full'>
          <Typography variant='body2' color='text.disabled'>
            {title === 'Revenue Growth' ? 'Monthly Reports' : title === 'Sales' ? 'Last 6 Months' : 'Last Month'}
          </Typography>
...
export default BelowStatistics
